...
GROUP_A = [
    ...
    ("YOLO11m-Pose+Data Augmentation+ECA+CBAM", W("yolo11m_pose_eca_cbam_e150_pat10_imgsz1280"), "attn"),
    ("YOLO11m-Pose+Data Augmentation+ECA+CBAM+C2PSA",
     W("yolo11m_pose_eca_cbam_c2psa_e150_pat10_imgsz1280"), "attn"),
    ("YOLO11m-Pose+Data Augmentation+ECA+CBAM+C2PSA+PDCA",
     W("yolo11m_pose_eca_cbam_c2psa_pdca_e150_pat10_imgsz1280"), "attn"),
