...
LADDER_ABLATION: list[Experiment] = [
    ...
    Experiment(
        ...
        run_name=_run("yolo11m_pose_combo_1_2"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2.yaml"),
        group="ladder_ablation",
        dat=True,
        eca_b2=True,
        cbam_b4=True,
    ...
    Experiment(
        ...
        run_name=_run("yolo11m_pose_combo_1_2_4"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2-4.yaml"),
        group="ladder_ablation",
        dat=True,
        eca_b2=True,
        cbam_b4=True,
    ...
    Experiment(
        ...
        model=_yaml("combos", "yolo11", "yolo11m-pose-pdca.yaml"),
        group="ladder_ablation",
        dat=True,
        pdca=True,
        register="attention",
    ...
    Experiment(
        id="ladder_combo_124_pdca",
        display_name="YOLO11m-Pose + ECA @ B2 + CBAM @ B4 + C2PSA @ B10 + PDCA",
        run_name=_run("yolo11m_pose_combo_1_2_4_pdca"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2-4-pdca.yaml"),
        group="ladder_ablation",
        dat=True,
        eca_b2=True,
        cbam_b4=True,
    ...
    Experiment(
        id="ladder_combo_124_pdca_seam",
        display_name="YOLO11m-Pose + ECA @ B2 + CBAM @ B4 + C2PSA @ B10 + PDCA + SEAM",
        run_name=_run("yolo11m_pose_combo_1_2_4_pdca_seam"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2-4-pdca-seam.yaml"),
        group="ladder_ablation",
        dat=True,
        eca_b2=True,
        cbam_b4=True,
...
METHOD_COMPARISON: list[Experiment] = [
    ...
    Experiment(
        id="method_yolo11m_combo_124",
        display_name="YOLO11m combo ECA@B2 + CBAM@B4 + C2PSA@B10",
        run_name=_run("yolo11m_pose_combo_1_2_4"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2-4.yaml"),
        group="method_comparison",
        eca_b2=True,
    ...
    Experiment(
        id="method_yolo11m_combo_124_pdca",
        display_name="YOLO11m combo ECA@B2 + CBAM@B4 + C2PSA@B10 + PDCA",
        run_name=_run("yolo11m_pose_combo_1_2_4_pdca"),
        model=_yaml("combos", "yolo11", "yolo11m-pose-combo-1-2-4-pdca.yaml"),
        group="method_comparison",
        eca_b2=True,
    ...
    Experiment(
        id="method_yolov8m_combo_124",
        display_name="YOLOv8m combo ECA@B2 + CBAM@B4 + C2PSA@B10",
        run_name=_run("yolov8m_pose_combo_1_2_4"),
        model=_yaml("combos", "yolo8", "yolo8m-pose-combo-1-2-4.yaml"),
        group="method_comparison",
        eca_b2=True,
        cbam_b4=True,
        c2psa_b10=True,
    ...
    Experiment(
        ...
        model=_yaml("combos", "yolo8", "yolo8m-pose-pdca.yaml"),
        group="method_comparison",
        pdca=True,
        register="attention",
        yolo_family="yolov8",
    ...
    Experiment(
        id="method_yolov8m_combo_124_pdca",
        display_name="YOLOv8m combo ECA@B2 + CBAM@B4 + C2PSA@B10 + PDCA",
        run_name=_run("yolov8m_pose_combo_1_2_4_pdca"),
        model=_yaml("combos", "yolo8", "yolo8m-pose-combo-1-2-4-pdca.yaml"),
        group="method_comparison",
        eca_b2=True,
        cbam_b4=True,
        c2psa_b10=True,
